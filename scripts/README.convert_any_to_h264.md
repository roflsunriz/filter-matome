...
## 概要
このツールは、様々な形式の動画ファイルをH.264、HEVC (H.265)、AV1形式に変換できる便利なGUIアプリケーションなのじゃ！
...
## 注意事項
- 初回起動時、TkinterDnD2が自動でインストールされるのじゃ
- FFmpegがインストールされていない場合は動作しないので注意するのじゃ
- 変換したファイルは実行フォルダに保存されるのじゃ

## エラー対応
もしエラーが発生したら、ログ表示欄を確認するのじゃ。主な対処方法は：
