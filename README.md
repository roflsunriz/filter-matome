...
[![Latest Version](https://img.shields.io/badge/latest-%23250.1-blue)](https://github.com/roflsunriz/filter-matome/releases/latest)
...
- **nlFilter API状態表示**: CommonHeaderの独立した`filter-matome`メニューで、再生速度同期・コメント再取得・コメントメニュー挿入をページ開始時と180秒ごとに自動検査し、有効／自動検査中／未検出／版不一致／検査失敗を確認
