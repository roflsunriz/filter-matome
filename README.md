...
[![Latest Version](https://img.shields.io/badge/latest-%23237-blue)](https://github.com/roflsunriz/filter-matome/releases/latest)
...
- **動画取得スケジューラー**: 動画・日時・確認の3段階ウィザードで予約し、繰り返し、祝日、帯域上限、容量判定、再試行、取得履歴を管理
