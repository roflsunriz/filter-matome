...
- **機能**: ヘッダー構築、動画カード生成、フォント読み込み、品質バッジ、利用不可バッジ、キャッシュ情報に基づく完了済み/テンポラリ動画の一括削除、getthumbinfo による不足メタデータ取得
...
- **役割**: ユーザー操作の処理・調整
- **機能**: クリックイベント、キーボード入力、API詳細取得、モーダル表示、キャッシュ情報に基づく動画削除、スクロールトップボタン
