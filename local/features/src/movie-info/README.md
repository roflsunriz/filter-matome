...
- `ext.nicovideo.jp/api/getthumbinfo/<動画ID>`: サムネイル情報。
- `/cache/mediainfo?<動画ID>`: ローカル動画のMediaInfo JSON。
...
4. 必要な場合だけコメントを取得し、プレビューと完全JSONの操作を有効にする。
5. 選択中データをコピーまたはファイルへ保存する。
