...
export const ARRAY_FIELD_KEYS: Set<string> = new Set([
    'NGRegex', 'OKRegex', 'superNgRegex', 'replaceRules', 'superNgReplaceRules',
    'userIdFilters', 'excludeUserIds', 'superUserIdFilters', 'excludeMovieIds',
    'NGWord', 'OKWord', 'superNgWords', 'specificNgUsers', 'specificNgWords'
]);
