...
export interface ToastrInstance {
    info(message: string, title?: string, options?: ToastrOptions): HTMLElement | undefined;
    success(message: string, title?: string, options?: ToastrOptions): HTMLElement | undefined;
    warning(message: string, title?: string, options?: ToastrOptions): HTMLElement | undefined;
    error(message: string, title?: string, options?: ToastrOptions): HTMLElement | undefined;
    clear(): void;
    version: string;
    ...
    animate(element: HTMLElement, animationOptions: { method: string; duration: number; easing: string }, callback?: () => void): void;
}
