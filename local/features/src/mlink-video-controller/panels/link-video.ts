...
import {
  ...
  updateWatchOnlyAvailability,
} from "./panel-keyboard-and-availability";
...
export class MlinkVideoController extends BasePanel {
  ...
  private async render() {
    try {
      ...
      updateWatchOnlyAvailability(this.shadow, this.isWatchPage, (tabId) =>
      ...
      // キー伝搬停止処理を設定
      setupKeyPropagationPrevention(this.shadow);
